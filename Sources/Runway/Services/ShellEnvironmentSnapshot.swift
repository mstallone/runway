...
struct ShellEnvironmentSnapshot: Codable, Equatable, Sendable {
    ...
    static let capturedKeys = [
        "CLAUDE_CONFIG_DIR", "CODEX_HOME", "XDG_CONFIG_HOME", "MUSE_AUTH_PATH",
...
/// UserDefaults persistence for the snapshot (`runway.shellEnvSnapshot.v1`). A class so the
...
final class ShellEnvironmentSnapshotStore: @unchecked Sendable {
    static let storageKey = "runway.shellEnvSnapshot.v1"
