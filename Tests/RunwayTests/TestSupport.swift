...
enum TestPricing {
    static let bundled: ModelPricing = {
        func resource(_ name: String) -> Data {
            guard let url = Bundle.runwayResources.url(forResource: name, withExtension: "json"),
...
enum ClaudeLogFixture {
    ...
    static func makeHome(files: [String: String] = [:]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("runway-claude-\(UUID().uuidString)", isDirectory: true)
    ...
    static func makeUserHome(
        ...
        let home = FileManager.default.temporaryDirectory
            .appendingPathComponent("runway-claude-home-\(UUID().uuidString)", isDirectory: true)
    ...
    static func scanner(home: URL?) -> ClaudeLogUsageScanner {
        ClaudeLogUsageScanner(
            ...
            homeDirectory: { FileManager.default.temporaryDirectory.appendingPathComponent("runway-no-claude-home") },
...
enum CodexLogFixture {
    ...
    static func makeHome(files: [String: String] = [:]) throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("runway-codex-\(UUID().uuidString)", isDirectory: true)
    ...
    static func scanner(home: URL?) -> CodexLogUsageScanner {
        CodexLogUsageScanner(
            ...
            homeDirectory: { FileManager.default.temporaryDirectory.appendingPathComponent("runway-no-codex-home") },
