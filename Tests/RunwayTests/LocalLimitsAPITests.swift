...
final class LocalLimitsAPITests: XCTestCase {
    private let fetchedAt = RunwayISO8601.date(from: "2026-07-13T01:39:30.000Z")!
    private let generatedAt = RunwayISO8601.date(from: "2026-07-13T01:40:00.000Z")!
    ...
    func testLimitsEnvelopeCarriesRawScalarsAndFreshnessWithoutUIPresentation() throws {
        ...
        let snapshot = ProviderSnapshot(
            ...
            lines: [
                .progress(
                    ...
                    resetsAt: RunwayISO8601.date(from: "2026-07-13T06:00:00.000Z"),
        ...
        XCTAssertEqual(root["schema"] as? String, "runway.limits.v1")
