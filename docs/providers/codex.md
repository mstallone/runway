...
Enable **Reset Expiry Reminders** in [Notifications settings](../settings.md#reset-expiry-reminders) for reminders 48 hours, 24 hours, 2 hours, 1 hour, and 15 minutes before a known credit expiry. Each reminder replaces the previous one for that provider card and expiry. A count-only response cannot produce expiry reminders.
