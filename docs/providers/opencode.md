...
Use OpenCode as usual. Runway reads the `opencode-go` API key from OpenCode's local data directory
...
- **Spend tiles show "No data"** — Runway needs OpenCode's local database at
