...
For Claude, the default layout keeps Session, Weekly, and Fable always visible. Codex and Grok keep only Weekly always visible. Sakana Fugu keeps Five-Hour Usage and Weekly Usage always visible. For those four providers, Usage Trend and the Today, Yesterday, and Last 30 Days rows start on demand. Codex also puts Rate Limit Resets there. Their other metrics start off. Other providers keep their core meters above the caret and secondary details on demand.
