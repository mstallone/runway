...
- [Reset expiry reminders](settings.md#reset-expiry-reminders) check every 30 seconds and when data or settings change, independently of the refresh batch. New reminders wait for that provider's first successful refresh after launch.
